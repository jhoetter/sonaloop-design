...
function genTs() {
  const lines = [];
  lines.push('/**');
  lines.push(' * sonaloop-icons — GENERATED by scripts/gen.mjs. Do not edit.');
  lines.push(' * Source of truth: icons.data.mjs');
  lines.push(' *');
  lines.push(' *   import { SearchIcon, PersonaHifi } from \'sonaloop-icons\'');
...
function genPy() {
  ...
  return `"""sonaloop-icons — GENERATED by scripts/gen.mjs. Do not edit.
