...
export const deckIconTints = ['accent'];            // palette roles rasterized per icon (the pillars chip tint; add roles only when a painter reads them)
...
export const layouts = [
  ...
  },
  {
    ...
    sample: {
      ...
      chart: {
        type: 'bar',
        categories: ['Lena', 'Sabine', 'Mehmet', 'Tom'],
        values: [4, 3, 2, 1],
      },
  ...
  },
  {
    ...
    usage: 'When two charts argue together. Keep the pair related — unrelated evidence gets two chart slides.',
    sample: {
      kind: 'charts',
      num: '03',
      ...
      items: [
        {
          ...
          chart: {
            type: 'bar',
            categories: ['Status quo', 'Pilot week 1', 'Pilot week 2'],
            values: [29, 64, 71],
          },
        },
        {
          ...
          chart: {
            type: 'gauge',
            items: [
              { label: 'Kept the menu', value: 3, max: 4 },
              { label: 'Would pay', value: 2, max: 4 },
            ],
          },
        },
      ],
  ...
  },
  {
    ...
    usage: 'About five columns fits; the first column is the row label. It is a real table — every cell stays editable.',
    sample: {
      kind: 'table',
      num: '03',
      heading: 'The panel at a glance',
      columns: ['Persona', 'Household', 'Cooks/week', '6 pm blocker', 'Default menu stance'],
      rows: [
        ['Lena, 34', 'Single, full-time', '2–3', 'Decision fatigue', 'Would pay today'],
        ['Mehmet, 23', 'Shared flat, student', '1–2', 'Budget + skill doubt', 'In under €60/week'],
        ['Sabine, 41', 'Family of four', '4–5', 'Kids veto dinners', 'Needs kid-safe swaps'],
        ['Tom, 29', 'Couple, remote dev', '3', 'Grocery-trip friction', 'Free + exportable only'],
      ],
